...
public class Lista_Reporte extends javax.swing.JFrame {
    ...
    private void btnGenerarReporteVendedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteVendedorActionPerformed
        ...
        IngreseID ventID = new IngreseID();
        ventID.setTipo(this.lblArriendoVendedor.getText());
        ventID.setVisible(true);
    ...
    private void btnGenerarReporte3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporte3ActionPerformed
        // TODO add your handling code here:
        Top5 venTop5 = new Top5();
        venTop5.tabla();
        venTop5.setVisible(true);
    ...
    private void btnGenerarReporte4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporte4ActionPerformed
        ValorRecaudado ventana = new ValorRecaudado();
        ventana.tabla();
