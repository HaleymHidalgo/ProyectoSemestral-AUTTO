...
public class CtrlArriendo {
    ...
    public List<Arriendo> listarArriendosVehiculos(String idVehiculo) {
        ...
        try {
            ...
            String query = "SELECT * FROM arriendo  WHERE patente_vehiculo='" + idVehiculo + "'";
    ...
    public List<Arriendo> listarArriendosVendedor(String idEmpleado) {
        List<Arriendo> listaArriendos = new ArrayList<Arriendo>();
        ...
        try {
            ...
            String query = "SELECT * FROM arriendo WHERE rut_empleado=? ORDER BY fecha_inicio DESC";
            PreparedStatement stmt = cnx.prepareStatement(query);
